...
<body>
				<div class="container" id="app">
								<br>
								<br>
								<p class="m-0 p-0 text-center">Laravel WebSockets</p>
								<h1 class="m-0 p-0 text-center">Chat App Example</h1>
								...
								<div class="card mt-4">
																...
																<form>
																				...
																				<div class="col-lg-1 col-md-2 col-sm-12 mt-2 p-0">
																								<button v-if="connected === false" v-on:click="connect()" type="button"
																												class="btn btn-sm btn-primary w-100 mr-2">
																												Connect
																								</button>
																								<button v-if="connected === true" v-on:click="disconnect()" type="button"
																												class="btn btn-sm btn-danger w-100 mr-2">
																												Disconnect
																								</button>
																				</div>
																</form>
												...
												<div v-if="connected === true" class="card-body">
																...
																<div class="col-12 bg-light mt-3 pb-2 pt-2">
																				<p class="m-0 p-0 pe-2 ps-2" v-for="(message, index) in incomingMessages">
																				...
																				<div class="row mt-2">
																								<div class="col-12 text-white" v-show="formError === true">
																												<div class="bg-danger mb-2 p-2">
																																<p class="m-0 p-0"><b>Error:</b> Invalid message.</p>
																												</div>
																								</div>
																								<div class="col-12">
